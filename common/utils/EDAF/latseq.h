...
#define LATSEQ_MAX_STR_SIZE 256 // Length for filelog_name AND latseq fingerprint string size
...
void incrementEDAFTxpdu();
int getEDAFTxpdu();
void incrementEDAFDLTxpdu();
int getEDAFDLTxpdu();
