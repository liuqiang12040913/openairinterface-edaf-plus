...
#define GNB_CONFIG_STRING_EDAF_ADDR                      "edaf_addr"

#define GNB_CONFIG_HLP_EDAF_ADDR   "EDAF output stream address, either file \"/tmp/edaf\" or ip:port \"192.168.2.2:50010\" "
...
{GNB_CONFIG_STRING_EDAF_ADDR,   GNB_CONFIG_HLP_EDAF_ADDR,     0,        strptr:NULL,   defstrval:NULL,                                    TYPE_STRING,      0}    \
}

#define GNB_ASN1_VERBOSITY_IDX                     0
#define GNB_ACTIVE_GNBS_IDX                        1
#define GNB_EDAF_ADDR_IDX 			   2
