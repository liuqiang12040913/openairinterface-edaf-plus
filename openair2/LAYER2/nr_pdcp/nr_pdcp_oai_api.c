...
#if EDAF
  LATSEQ_P("U pdcp.cipher--pdcp.pdu","len%u::rb%d.sduid%d.PCbuf%u.R1buf%u", size,rb_id,sdu_id,(uint8_t*)buf,(uint8_t*)memblock);
#endif
...
#if EDAF
    LATSEQ_P("D pdcp.cipher--pdcp.pdu","len%u::rb%d.sduid%d.PCbuf%u.R1buf%u", size,rb_id,sdu_id,(uint8_t*)buf,(uint8_t*)memblock);
#endif
