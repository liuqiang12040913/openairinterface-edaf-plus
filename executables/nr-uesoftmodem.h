...
#define  UE_CONFIG_HLP_EDAF_ADDR              "EDAF output stream address, either file \"/tmp/edaf\" or ip:port \"192.168.2.2:50010\" \n"
/***************************************************************************************************************************************/
...
#define CMDLINE_NRUEPARAMS_DESC {  \
  ...
  {"edaf-addr",                    UE_CONFIG_HLP_EDAF_ADDR,    0,               .strptr=&edaf_addr,                           .defstrval=NULL,                TYPE_STRING,      0}, \
}
// clang-format on
